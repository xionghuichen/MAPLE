...
MUJOCO_ENVIRONMENTS_PATH = '{}.mujoco'.format(CUSTOM_GYM_ENVIRONMENTS_PATH)
...
MUJOCO_ENVIRONMENT_SPECS = (
    ...
    {
        'id': 'AntAngle-Parameterizable-v3',
        'entry_point': ('gym.envs.mujoco.ant_v3_angle:AntEnv'),
    },
    {
    ...
    },
    {
        ...
        'entry_point': ('{}.pusher_2d:Pusher2dEnv'.format(MUJOCO_ENVIRONMENTS_PATH)),
    },
    {
        'id': 'Pusher2d-DefaultReach-v0',
        'entry_point': ('{}.pusher_2d:ForkReacherEnv'.format(MUJOCO_ENVIRONMENTS_PATH)),
    },
    {
        'id': 'Pusher2d-ImageDefault-v0',
        'entry_point': ('{}.image_pusher_2d:ImagePusher2dEnv'.format(MUJOCO_ENVIRONMENTS_PATH)),
    },
    {
        'id': 'Pusher2d-ImageReach-v0',
        'entry_point': ('{}.image_pusher_2d:ImageForkReacher2dEnv'.format(MUJOCO_ENVIRONMENTS_PATH)),
    },
    {
        'id': 'Pusher2d-BlindReach-v0',
        'entry_point': ('{}.image_pusher_2d:BlindForkReacher2dEnv'.format(MUJOCO_ENVIRONMENTS_PATH)),
    },
)
...
GENERAL_ENVIRONMENT_SPECS = (
    {
        ...
        'entry_point': ('{}.multi_goal:MultiGoalEnv'.format(CUSTOM_GYM_ENVIRONMENTS_PATH))
    },
)
...
MULTIWORLD_ENVIRONMENT_SPECS = (
    ...
    {
        'id': 'Point2DEnv-Offline-v0',
        'entry_point': 'multiworld.envs.pygame.point2d:Point2DEnv',
        'kwargs': {
            'initial_position' : np.array([-4, 0]),
            'fixed_goal' : np.array([4, 0]),
            'randomize_position_on_reset' : False
        }
    },
    {
        'id': 'Point2DWallEnv-Offline-v0',
        'entry_point': 'multiworld.envs.pygame.point2d:Point2DWallEnv',
        'kwargs': {
            'wall_shape': "big-u",
            'initial_position' : np.array([-4, 0]),
